...
//  fftwf_plan plan = fftwf_plan_many_dft(
//      1, &fft_size, batch_size, xt_fftw, &fft_size, 1, 0,
//      xf_fftw, &fft_size, 1, 0, FFTW_FORWARD, FFTW_MEASURE);
  ...
  //dft_codelet_c2cf_32(xt, xt + 1, xf, xf + 1, 2, 2, batch_size / 16, (2 * fft_size), (2 * fft_size));
  dft_c2cf_12(xt, xt + 1, xf, xf + 1, 2, 2, 1, 0, 0);
