/* Generated by: ./gen_notw.native -n 64 -standalone -fma -generic-arith -compact -name dft_codelet_c2cf_64 */
 ...
 */
void dft_codelet_c2cf_64(const R * ri, const R * ii, R * ro, R * io, stride is, stride os, INT v, INT ivs, INT ovs)
{
